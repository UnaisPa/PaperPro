      ...
      <div className="md:w-2/5 sm:w-4/5 w-11/12 rounded-md text-xs my-2 mx-auto bg-[#4C525E]">
        <div className="text-slate-300 py-4 px-6">
          <div className=" flex" >
            ...
            <div className="ml-2" >
              <h5 className="text-lg font-semibold text-white" >Muhameed Aiman</h5>
          ...
          <div className="my-2">
            ...
            <p className={`line-clamp-${expanded ? 'none' : '3'} leading-5 text-[0.87rem]`} >
              {description}
        ...
        >
          {expanded ? 'Read Less' : 'Read More'}
            ...
            <div className="border mt-2 h-48 rounded-md" >

            </div>
          </div>
          <div className="flex" >
            <div className="flex hover:text-slate-100 cursor-pointer" >
            {like? <GoHeartFill onClick={()=>setLike(false)} color="#FF5757" size={18} /> :<GoHeart onClick={()=>setLike(true)} size={18} />}
