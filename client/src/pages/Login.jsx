    ...
    <>
      ...
      <div className="flex p-2 h-[80vh] sm:h-full align-middle justify-center">
        <div className="hidden my-auto mx-20 md:block sm:w-2/5 p-5">
            <h2 className="text-secondary text-xl font-medium" >Sign In to <span className="text-primary opacity-75" >Paper pro</span> </h2>
            <p className="text-secondary opacity-75 text-sm mt-2" >Sign in to your paper trading account and practice trading with virtual funds. 📈 Get hands-on experience without the risk!</p>
            <p className="text-secondary text-xs opacity-75 mt-3" >Don't have an account? <span className="text-indigo-300 cursor-pointer hover:text-indigo-200" >Sign Up</span></p>
        </div>
        <div className=" my-auto w-full sm:w-3/5 p-5">
          <div className="mt-1  sm:mx-auto sm:w-full sm:max-w-sm" >
            <h1 className="text-2xl text-white font-medium text-center sm:text-start mb-20 sm:mb-0" >Sign In</h1>
            <form onSubmit={handlForm} className="space-y-6 mt-7">
              <div>
                ...
                >
                 {validateErrors.email ? validateErrors.email : "Your Email addresss"}
                </label>
                <div className="mt-2">
                  <input
                    id="email"
            ...
            <div className="" >
                <p className="text-center text-secondary text-xs opacity-65 m-5" >Or continue with</p>
                <FcGoogle size={27} className="mx-auto hover:animate-spin cursor-pointer" />
            </div>
          </div>
        </div>
      </div>
