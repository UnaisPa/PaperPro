          ...
          <div className="border mt-10 sm:mt-0 w-full">
            <div className="m-5 " >
              <div className="flex" >
                ...
                <h6 className="text-white text-xl font-semibold ml-5" >Easy to use interface</h6>
              </div>
              <p  className="text-secondary opacity-80 text-xs mt-2" >Simple and easy-to-use interface that doesn't get in the way of your learning. Navigate the markets effortlessly, focusing on what matters most - your growth.</p>
            </div>
